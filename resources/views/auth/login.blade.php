...
<div class="login-container">
  ...
  <form method="POST" class="form login" action="{{ route('login') }}">
    ...
    <div class="form__field form__field--email">
      <label class="label label--icon" for="email" value="{{ __('Email') }}">
        <svg class="icon">
      ...
      <div class="form__input-wrapper">
        <input id="email" type="email" name="email" :value="old('email')" required autofocus class="form__input" placeholder="Email">
        <!--
    ...
    <div class="form__field form__field--password">
      <label class="label label--icon" for="password" value="{{ __('Password') }}">
        <svg class="icon">
      ...
      <div class="form__input-wrapper">
        <input id="password" type="password" name="password" required autocomplete="current-password" class="form__input" placeholder="Password">
        <!--
            FF is ignoring position relative of form__input-wrapper so added a wrapper for .underline.
            NOTE: just the precense of this comment fixes this FF issue (making the underline-wrapper unncessary).
            But I'd rather not rely on a comment.
